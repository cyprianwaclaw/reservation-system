<template>
  <div class="calendar">
    ...
    <div class="calendar-header">
      <button class="nav-btn" @click="prevMonth" :disabled="!canGoPrev" aria-label="Poprzedni miesiąc">‹</button>
      <div class="month-label">{{ monthLabel }}</div>
      <button class="nav-btn"  @click="nextMonth" :disabled="!canGoNext" aria-label="Następny miesiąc">›</button>
    </div>
...
async function loadAvailableDays() {
  try {
    ...
    // Obliczamy liczbę dni między dziś a ten sam dzień następnego miesiąca
